...
import { getReportsData } from '@/actions/admin'
import { formatCurrency, getAppointmentStatusLabel } from '@/lib/utils'
...
export default async function AdminReportsPage({
  ...
  const reportsResult = await getReportsData(monthsBack)
  if (!reportsResult.success || !reportsResult.data) {
    return <div className="text-red-400 p-8">Erro ao carregar relatórios: {(reportsResult as any).error}</div>
  }
